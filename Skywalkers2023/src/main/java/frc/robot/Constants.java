...
public static final class Limelight3Constants {
    public static double kPx = 0.3; //meters
    ...
    public static double xclamp = 0.3; 
    public static double yclamp = 0.3;
    ...
    public static double cameraheight = Units.inchesToMeters(14); //tape location
}
