...
public class RobotContainer {
  ...
  private final limelight3 camera = new limelight3();
  ...
  public RobotContainer() {
    ...
    //swerve.setDefaultCommand(new MoveToTag(camera, swerve, 0, 0.5, 0));
  ...
  private void configureButtonBindings() {
    ...
    driverJoystick.x().onTrue(new MoveToTag(camera, swerve, 0, 1, 0));
